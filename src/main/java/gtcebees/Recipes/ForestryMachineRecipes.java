...
public class ForestryMachineRecipes {
    public static void init() {
        ...
        RecipeManagers.centrifugeManager.addRecipe(20, GTCombItem.getComb(GTCombs.OIL, 1), ImmutableMap.of(MetaItems.CROP_DROP_OIL_BERRY.getStackForm(2), 0.7f, ModuleCore.getItems().beeswax.getItemStack(), 0.3f));
